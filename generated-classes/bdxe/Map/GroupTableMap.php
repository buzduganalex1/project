...
/**
 * This class defines the structure of the 'group_tb' table.
 *
 *
 *
...
class GroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'bdxe.Map.GroupTableMap';
     ...
     */
    const TABLE_NAME = 'group_tb';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\bdxe\\Group';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'bdxe.Group';
     ...
     */
    const COL_ID = 'group_tb.id';

    /**
     * the column name for the project_id field
     */
    const COL_PROJECT_ID = 'group_tb.project_id';

    /**
     * the column name for the nr field
     */
    const COL_NR = 'group_tb.nr';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ProjectId', 'Nr', ),
        self::TYPE_CAMELNAME     => array('id', 'projectId', 'nr', ),
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID, GroupTableMap::COL_PROJECT_ID, GroupTableMap::COL_NR, ),
        self::TYPE_FIELDNAME     => array('id', 'project_id', 'nr', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ProjectId' => 1, 'Nr' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'projectId' => 1, 'nr' => 2, ),
        self::TYPE_COLNAME       => array(GroupTableMap::COL_ID => 0, GroupTableMap::COL_PROJECT_ID => 1, GroupTableMap::COL_NR => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'project_id' => 1, 'nr' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(GroupTableMap::COL_PROJECT_ID);
            $criteria->addSelectColumn(GroupTableMap::COL_NR);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \bdxe\Group) { // it's a model object
