...
class UsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'bdxe.Map.UsersTableMap';
     ...
     */
    const OM_CLASS = '\\bdxe\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'bdxe.Users';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Email', 'Type', 'Password', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'email', 'type', 'password', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_NAME, UsersTableMap::COL_EMAIL, UsersTableMap::COL_TYPE, UsersTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'email', 'type', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Email' => 2, 'Type' => 3, 'Password' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'type' => 3, 'password' => 4, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_NAME => 1, UsersTableMap::COL_EMAIL => 2, UsersTableMap::COL_TYPE => 3, UsersTableMap::COL_PASSWORD => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'type' => 3, 'password' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\bdxe\\Users');
        $this->setPackage('bdxe');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('Users_SEQ');
        // columns
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \bdxe\Users) { // it's a model object
