...
use bdxe\Subscription;
use bdxe\SubscriptionQuery;


/**
 * This class defines the structure of the 'subscription_tb' table.
 *
 *
 *
...
class SubscriptionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'bdxe.Map.SubscriptionTableMap';
     ...
     */
    const TABLE_NAME = 'subscription_tb';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\bdxe\\Subscription';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'bdxe.Subscription';
     ...
     */
    const COL_ID = 'subscription_tb.id';

    /**
     * the column name for the student_id field
     */
    const COL_STUDENT_ID = 'subscription_tb.student_id';

    /**
     * the column name for the course_id field
     */
    const COL_COURSE_ID = 'subscription_tb.course_id';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SubscriptionTableMap::COL_ID, SubscriptionTableMap::COL_STUDENT_ID, SubscriptionTableMap::COL_COURSE_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SubscriptionTableMap::COL_ID => 0, SubscriptionTableMap::COL_STUDENT_ID => 1, SubscriptionTableMap::COL_COURSE_ID => 2, ),
    ...
    {
        // attributes
        $this->setName('subscription_tb');
        $this->setPhpName('Subscription');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\bdxe\\Subscription');
        $this->setPackage('bdxe');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('subscription_tb_SEQ');
        // columns
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Pack', '\\bdxe\\Pack', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':subscription_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SubscriptionTableMap::COL_STUDENT_ID);
            $criteria->addSelectColumn(SubscriptionTableMap::COL_COURSE_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \bdxe\Subscription) { // it's a model object
