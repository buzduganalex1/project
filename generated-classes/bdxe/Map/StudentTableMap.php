...
class StudentTableMap extends TableMap
{
     ...
     */
    const COL_REQUEST = 'student_tb.Request';

    /**
     * the column name for the TeacherMessage field
     */
    const COL_TEACHERMESSAGE = 'student_tb.TeacherMessage';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Email', 'Request', 'Teachermessage', 'Password', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'email', 'request', 'teachermessage', 'password', ),
        self::TYPE_COLNAME       => array(StudentTableMap::COL_ID, StudentTableMap::COL_NAME, StudentTableMap::COL_EMAIL, StudentTableMap::COL_REQUEST, StudentTableMap::COL_TEACHERMESSAGE, StudentTableMap::COL_PASSWORD, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'email', 'Request', 'TeacherMessage', 'password', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Email' => 2, 'Request' => 3, 'Teachermessage' => 4, 'Password' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'request' => 3, 'teachermessage' => 4, 'password' => 5, ),
        self::TYPE_COLNAME       => array(StudentTableMap::COL_ID => 0, StudentTableMap::COL_NAME => 1, StudentTableMap::COL_EMAIL => 2, StudentTableMap::COL_REQUEST => 3, StudentTableMap::COL_TEACHERMESSAGE => 4, StudentTableMap::COL_PASSWORD => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'email' => 2, 'Request' => 3, 'TeacherMessage' => 4, 'password' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('Request', 'Request', 'INTEGER', false, null, null);
        $this->addColumn('TeacherMessage', 'Teachermessage', 'VARCHAR', false, 255, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StudentTableMap::COL_REQUEST);
            $criteria->addSelectColumn(StudentTableMap::COL_TEACHERMESSAGE);
            ...
            $criteria->addSelectColumn($alias . '.TeacherMessage');
