...
class CourseTableMap extends TableMap
{
    ...
    /**
     * the column name for the Initial_Class_Capacity field
     */
    const COL_INITIAL_CLASS_CAPACITY = 'course_tb.Initial_Class_Capacity';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ProfesorId', 'SubjectId', 'SubjectName', 'ClassCapacity', 'InitialClassCapacity', 'StartDate', 'FinishDate', ),
        self::TYPE_CAMELNAME     => array('id', 'profesorId', 'subjectId', 'subjectName', 'classCapacity', 'initialClassCapacity', 'startDate', 'finishDate', ),
        self::TYPE_COLNAME       => array(CourseTableMap::COL_ID, CourseTableMap::COL_PROFESOR_ID, CourseTableMap::COL_SUBJECT_ID, CourseTableMap::COL_SUBJECT_NAME, CourseTableMap::COL_CLASS_CAPACITY, CourseTableMap::COL_INITIAL_CLASS_CAPACITY, CourseTableMap::COL_START_DATE, CourseTableMap::COL_FINISH_DATE, ),
        self::TYPE_FIELDNAME     => array('id', 'profesor_id', 'subject_id', 'Subject_Name', 'Class_Capacity', 'Initial_Class_Capacity', 'Start_Date', 'Finish_Date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ProfesorId' => 1, 'SubjectId' => 2, 'SubjectName' => 3, 'ClassCapacity' => 4, 'InitialClassCapacity' => 5, 'StartDate' => 6, 'FinishDate' => 7, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'profesorId' => 1, 'subjectId' => 2, 'subjectName' => 3, 'classCapacity' => 4, 'initialClassCapacity' => 5, 'startDate' => 6, 'finishDate' => 7, ),
        self::TYPE_COLNAME       => array(CourseTableMap::COL_ID => 0, CourseTableMap::COL_PROFESOR_ID => 1, CourseTableMap::COL_SUBJECT_ID => 2, CourseTableMap::COL_SUBJECT_NAME => 3, CourseTableMap::COL_CLASS_CAPACITY => 4, CourseTableMap::COL_INITIAL_CLASS_CAPACITY => 5, CourseTableMap::COL_START_DATE => 6, CourseTableMap::COL_FINISH_DATE => 7, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'profesor_id' => 1, 'subject_id' => 2, 'Subject_Name' => 3, 'Class_Capacity' => 4, 'Initial_Class_Capacity' => 5, 'Start_Date' => 6, 'Finish_Date' => 7, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('Initial_Class_Capacity', 'InitialClassCapacity', 'INTEGER', false, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CourseTableMap::COL_INITIAL_CLASS_CAPACITY);
            ...
            $criteria->addSelectColumn($alias . '.Initial_Class_Capacity');
