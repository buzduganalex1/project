...
/**
 * This class defines the structure of the 'test_tb' table.
 *
 *
 *
...
class TestTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'bdxe.Map.TestTableMap';
     ...
     */
    const TABLE_NAME = 'test_tb';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\bdxe\\Test';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'bdxe.Test';
     ...
     */
    const COL_ID = 'test_tb.id';

    /**
     * the column name for the course_id field
     */
    const COL_COURSE_ID = 'test_tb.course_id';

    /**
     * the column name for the Materie field
     */
    const COL_MATERIE = 'test_tb.Materie';

    /**
     * the column name for the DueTime field
     */
    const COL_DUETIME = 'test_tb.DueTime';

    /**
     * the column name for the PostTime field
     */
    const COL_POSTTIME = 'test_tb.PostTime';

    /**
     * the column name for the Nota field
     */
    const COL_NOTA = 'test_tb.Nota';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TestTableMap::COL_ID, TestTableMap::COL_COURSE_ID, TestTableMap::COL_MATERIE, TestTableMap::COL_DUETIME, TestTableMap::COL_POSTTIME, TestTableMap::COL_NOTA, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TestTableMap::COL_ID => 0, TestTableMap::COL_COURSE_ID => 1, TestTableMap::COL_MATERIE => 2, TestTableMap::COL_DUETIME => 3, TestTableMap::COL_POSTTIME => 4, TestTableMap::COL_NOTA => 5, ),
    ...
    {
        // attributes
        $this->setName('test_tb');
        $this->setPhpName('Test');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\bdxe\\Test');
        $this->setPackage('bdxe');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('test_tb_SEQ');
        // columns
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('TestEval', '\\bdxe\\TestEval', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':test_id',
    1 => ':id',
  ),
), null, null, 'TestEvals', false);
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TestTableMap::COL_COURSE_ID);
            $criteria->addSelectColumn(TestTableMap::COL_MATERIE);
            $criteria->addSelectColumn(TestTableMap::COL_DUETIME);
            $criteria->addSelectColumn(TestTableMap::COL_POSTTIME);
            $criteria->addSelectColumn(TestTableMap::COL_NOTA);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \bdxe\Test) { // it's a model object
