...
use bdxe\Subject;
use bdxe\SubjectQuery;


/**
 * This class defines the structure of the 'subject_tb' table.
 *
 *
 *
...
class SubjectTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'bdxe.Map.SubjectTableMap';
     ...
     */
    const TABLE_NAME = 'subject_tb';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\bdxe\\Subject';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'bdxe.Subject';
    ...
    {
        // attributes
        $this->setName('subject_tb');
        $this->setPhpName('Subject');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\bdxe\\Subject');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \bdxe\Subject) { // it's a model object
