...
use bdxe\UsersQuery as ChildUsersQuery;
use bdxe\Map\UsersTableMap;
...
abstract class Users implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\bdxe\\Map\\UsersTableMap';
    ...
    /**
     * Initializes internal state of bdxe\Base\Users object.
     */
     ...
     * @return $this|\bdxe\Users The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UsersTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\bdxe\\Users'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {                
                $dataFetcher = $con->query('SELECT Users_SEQ.nextval FROM dual');
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\bdxe\Users The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \bdxe\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \bdxe\Users Clone of current object.
     * @throws PropelException
     */
