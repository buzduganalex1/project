...
/**
 * Base class that represents a row from the 'profesor_tb' table.
 *
 * 
 *
* @package    propel.generator.bdxe.Base
*/
abstract class Profesor implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\bdxe\\Map\\ProfesorTableMap';
    ...
    /**
     * Initializes internal state of bdxe\Base\Profesor object.
     */
    ...
    /**
     * Compares this with another <code>Profesor</code> instance.  If
     * <code>obj</code> is an instance of <code>Profesor</code>, delegates to
     * <code>equals(Profesor)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Profesor The current object, for fluid interface
     */
     ...
     * @return $this|\bdxe\Profesor The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProfesorTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[ProfesorTableMap::COL_NAME] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[ProfesorTableMap::COL_EMAIL] = true;
        }
    ...
    public function setPassword($v)
    {
        ...
        if ($this->password !== $v) {
            $this->password = $v;
            $this->modifiedColumns[ProfesorTableMap::COL_PASSWORD] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProfesorTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProfesorTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProfesorTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProfesorTableMap::translateFieldName('Password', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ProfesorTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\bdxe\\Profesor'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProfesorQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Profesor::setDeleted()
     * @see Profesor::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProfesorQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProfesorTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ProfesorTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ProfesorTableMap::COL_ID . ')');
        }
        if (null === $this->id) {
            try {                
                $dataFetcher = $con->query('SELECT profesor_tb_SEQ.nextval FROM dual');
        ...
        if ($this->isColumnModified(ProfesorTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ProfesorTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ProfesorTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(ProfesorTableMap::COL_PASSWORD)) {
            $modifiedColumns[':p' . $index++]  = 'password';
        }

        $sql = sprintf(
            'INSERT INTO profesor_tb (%s) VALUES (%s)',
    ...
    {
        $pos = ProfesorTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Profesor'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Profesor'][$this->hashCode()] = true;
        $keys = ProfesorTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\bdxe\Profesor The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(ProfesorTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ProfesorTableMap::COL_ID)) {
            $criteria->add(ProfesorTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ProfesorTableMap::COL_NAME)) {
            $criteria->add(ProfesorTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ProfesorTableMap::COL_EMAIL)) {
            $criteria->add(ProfesorTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(ProfesorTableMap::COL_PASSWORD)) {
            $criteria->add(ProfesorTableMap::COL_PASSWORD, $this->password);
        }
    ...
    {
        $criteria = ChildProfesorQuery::create();
        $criteria->add(ProfesorTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \bdxe\Profesor (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \bdxe\Profesor Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildProfesor is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildProfesor The current object (for fluent API support)
     */
    public function setCourses(Collection $courses, ConnectionInterface $con = null)
    {
        ...
        foreach ($coursesToDelete as $courseRemoved) {
            $courseRemoved->setProfesor(null);
        }
     ...
     * Otherwise if this Profesor is new, it will return
     * an empty collection; or if this Profesor has previously
     * been saved, it will retrieve related Courses from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Profesor.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        return (string) $this->exportTo(ProfesorTableMap::DEFAULT_STRING_FORMAT);
    }
