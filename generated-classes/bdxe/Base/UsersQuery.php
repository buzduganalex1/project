...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \bdxe\Base\UsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\bdxe\\Users', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, email, type, password FROM Users WHERE id = :p0';
        try {
