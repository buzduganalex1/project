...
use bdxe\Map\ProjectEvalTableMap;

/**
 * Base class that represents a query for the 'projecteval_tb' table.
 *
 * 
 *
 ...
 * @method     ChildProjectEvalQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildProjectEvalQuery leftJoinProject($relationAlias = null) Adds a LEFT JOIN clause to the query using the Project relation
 * @method     ChildProjectEvalQuery rightJoinProject($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Project relation
 * @method     ChildProjectEvalQuery innerJoinProject($relationAlias = null) Adds a INNER JOIN clause to the query using the Project relation
 *
 * @method     ChildProjectEvalQuery leftJoinSubscription($relationAlias = null) Adds a LEFT JOIN clause to the query using the Subscription relation
 * @method     ChildProjectEvalQuery rightJoinSubscription($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Subscription relation
 * @method     ChildProjectEvalQuery innerJoinSubscription($relationAlias = null) Adds a INNER JOIN clause to the query using the Subscription relation
 *
 * @method     \bdxe\ProjectQuery|\bdxe\SubscriptionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 * @method     ChildProjectEval findOne(ConnectionInterface $con = null) Return the first ChildProjectEval matching the query
 * @method     ChildProjectEval findOneOrCreate(ConnectionInterface $con = null) Return the first ChildProjectEval matching the query, or a new ChildProjectEval object populated from the query conditions when no match is found
 *
 ...
 *
 */
abstract class ProjectEvalQuery extends ModelCriteria
{
    protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';

    /**
     * Initializes internal state of \bdxe\Base\ProjectEvalQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\bdxe\\ProjectEval', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildProjectEvalQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildProjectEvalQuery
     */
    public static function create($modelAlias = null, Criteria $criteria = null)
    {
        if ($criteria instanceof ChildProjectEvalQuery) {
            return $criteria;
        }
        $query = new ChildProjectEvalQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildProjectEval|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ProjectEvalTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
            // the object is already in the instance pool
            return $obj;
        }
        if ($con === null) {
            $con = Propel::getServiceContainer()->getReadConnection(ProjectEvalTableMap::DATABASE_NAME);
        }
     ...
     *
     * @return ChildProjectEval A model object, or null if the key is not found
     */
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            /** @var ChildProjectEval $obj */
            $obj = new ChildProjectEval();
            $obj->hydrate($row);
            ProjectEvalTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ProjectEvalTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ProjectEvalTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(ProjectEvalTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(ProjectEvalTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectEvalTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByProjectId($projectId = null, $comparison = null)
    {
        if (is_array($projectId)) {
            ...
            if (isset($projectId['min'])) {
                $this->addUsingAlias(ProjectEvalTableMap::COL_PROJECT_ID, $projectId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($projectId['max'])) {
                $this->addUsingAlias(ProjectEvalTableMap::COL_PROJECT_ID, $projectId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectEvalTableMap::COL_PROJECT_ID, $projectId, $comparison);
    }
    ...
    public function filterBySubscriptionId($subscriptionId = null, $comparison = null)
    {
        if (is_array($subscriptionId)) {
            ...
            if (isset($subscriptionId['min'])) {
                $this->addUsingAlias(ProjectEvalTableMap::COL_SUBSCRIPTION_ID, $subscriptionId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($subscriptionId['max'])) {
                $this->addUsingAlias(ProjectEvalTableMap::COL_SUBSCRIPTION_ID, $subscriptionId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildProjectEvalQuery The current query, for fluid interface
     */
    public function filterByProject($project, $comparison = null)
    {
        if ($project instanceof \bdxe\Project) {
            return $this
                ->addUsingAlias(ProjectEvalTableMap::COL_PROJECT_ID, $project->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ProjectEvalTableMap::COL_PROJECT_ID, $project->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterBySubscription($subscription, $comparison = null)
    {
        if ($subscription instanceof \bdxe\Subscription) {
            return $this
                ->addUsingAlias(ProjectEvalTableMap::COL_SUBSCRIPTION_ID, $subscription->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ProjectEvalTableMap::COL_SUBSCRIPTION_ID, $subscription->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   ChildProjectEval $projectEval Object to remove from the list of results
     *
     * @return $this|ChildProjectEvalQuery The current query, for fluid interface
     */
    public function prune($projectEval = null)
    {
        if ($projectEval) {
            $this->addUsingAlias(ProjectEvalTableMap::COL_ID, $projectEval->getId(), Criteria::NOT_EQUAL);
        }
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            ProjectEvalTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(ProjectEvalTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            ProjectEvalTableMap::removeInstanceFromPool($criteria);
