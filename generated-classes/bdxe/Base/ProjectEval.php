...
/**
 * Base class that represents a row from the 'projecteval_tb' table.
 *
 * 
 *
* @package    propel.generator.bdxe.Base
*/
abstract class ProjectEval implements ActiveRecordInterface 
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\bdxe\\Map\\ProjectEvalTableMap';
    ...
    /**
     * Initializes internal state of bdxe\Base\ProjectEval object.
     */
    ...
    /**
     * Compares this with another <code>ProjectEval</code> instance.  If
     * <code>obj</code> is an instance of <code>ProjectEval</code>, delegates to
     * <code>equals(ProjectEval)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ProjectEval The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ProjectEvalTableMap::COL_ID] = true;
        }
    ...
    public function setProjectId($v)
    {
        ...
        if ($this->project_id !== $v) {
            $this->project_id = $v;
            $this->modifiedColumns[ProjectEvalTableMap::COL_PROJECT_ID] = true;
        }
    ...
    public function setSubscriptionId($v)
    {
        ...
        if ($this->subscription_id !== $v) {
            ...
            $this->modifiedColumns[ProjectEvalTableMap::COL_SUBSCRIPTION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProjectEvalTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProjectEvalTableMap::translateFieldName('ProjectId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProjectEvalQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProjectEval::setDeleted()
     * @see ProjectEval::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildProjectEvalQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProjectEvalTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {                
                $dataFetcher = $con->query('SELECT projecteval_tb_SEQ.nextval FROM dual');
        ...
        if ($this->isColumnModified(ProjectEvalTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ProjectEvalTableMap::COL_PROJECT_ID)) {
    ...
    {
        $pos = ProjectEvalTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ProjectEval'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProjectEval'][$this->hashCode()] = true;
        $keys = ProjectEvalTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\bdxe\ProjectEval The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectEvalTableMap::COL_ID)) {
            $criteria->add(ProjectEvalTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ProjectEvalTableMap::COL_PROJECT_ID)) {
            $criteria->add(ProjectEvalTableMap::COL_PROJECT_ID, $this->project_id);
        }
        if ($this->isColumnModified(ProjectEvalTableMap::COL_SUBSCRIPTION_ID)) {
    ...
    {
        $criteria = ChildProjectEvalQuery::create();
        $criteria->add(ProjectEvalTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \bdxe\ProjectEval (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \bdxe\ProjectEval Clone of current object.
     * @throws PropelException
     */
    ...
    public function getProject(ConnectionInterface $con = null)
    {
        if ($this->aProject === null && ($this->project_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProject->addProjectEvals($this);
             */
        }
    ...
    public function getSubscription(ConnectionInterface $con = null)
    {
        if ($this->aSubscription === null && ($this->subscription_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSubscription->addProjectEvals($this);
             */
        }
    ...
    {
        if (null !== $this->aProject) {
            $this->aProject->removeProjectEval($this);
        }
        if (null !== $this->aSubscription) {
            $this->aSubscription->removeProjectEval($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(ProjectEvalTableMap::DEFAULT_STRING_FORMAT);
    }
