...
/**
 * Base class that represents a row from the 'subject_tb' table.
 *
 * 
 *
...
abstract class Subject implements ActiveRecordInterface 
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\bdxe\\Map\\SubjectTableMap';
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if (null === $this->id) {
            try {                
                $dataFetcher = $con->query('SELECT subject_tb_SEQ.nextval FROM dual');
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\bdxe\Subject The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \bdxe\Subject (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \bdxe\Subject Clone of current object.
     * @throws PropelException
     */
